...
To run this project, you will need a Groq API Key (Free Tier). Add the following to your application.properties:Properties
...
he system follows a Triangle Relationship for data integrity:
